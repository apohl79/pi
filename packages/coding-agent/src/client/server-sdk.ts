...
export type CreateServerAgentSessionOptions = Pick<ConfiguredCodingAgentDaemonRuntimeOptions, "models" | "model"> &
	Partial<
...
export async function createServerAgentSession(options: CreateServerAgentSessionOptions): Promise<ServerAgentSession> {
